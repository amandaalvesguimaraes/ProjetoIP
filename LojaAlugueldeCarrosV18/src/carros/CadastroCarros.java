...
private RepositorioCarros carros;
	...
	// add NPAException
	public void atualizar(Carros carro, String pa) throws PEException, NPAException, CCException, PNEException, QPIException, PDIException, ANException { //p é a nova placa e pa é a placa antiga
