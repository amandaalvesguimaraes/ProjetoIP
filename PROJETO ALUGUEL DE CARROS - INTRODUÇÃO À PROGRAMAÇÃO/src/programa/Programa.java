...
public class Programa {
	...
	public static void main(String[] args) throws CCException, QPIException, PDIException, ANException, PNEException, PEException, VCException, MATException, TELException, CPFException, FNEException, MNException, CJCexception, IDexception, CNexception, CJAException, CJACException, CaNCException, CNCException, VNCException, DiaIException, ANEException, CNAException {
		...
		while (repetir) {
			...
			case "16":
				...
				a = in.nextLine();
				a = a.trim();
				Cliente client = cf.procurarCliente(a);
			...
			case "17":
				...
				pa = pa.trim();
				Carros car1;
				car1 = cadastrocarro.procurar(pa);
			...
			case "19":
				...
				a = in.nextLine();
				a = a.trim();
				Cliente client2 = cf.procurarCliente(a);
				System.out.print("Digite a placa do carro que o cliente deseja alugar: ");
				b = in.nextLine();
				b = b.trim();
				Carros car2;
				car2 = cadastrocarro.procurar(b);
				System.out.print("Digite a quantidade de dias que o cliente vai alugar o carro: ");
				while (diasinvalidos) {
					if (in.hasNextInt()) {
						dias = in.nextInt();
			...
			case "20":
				...
				a = in.nextLine();
				a = a.trim();
				Aluguel a1 = cf.procurarAluguelCliente(a);
			...
			case "21":
				...
				a = in.nextLine();
				a = a.trim();
				Aluguel a2 = cf.procurarAluguelCarro(a);
